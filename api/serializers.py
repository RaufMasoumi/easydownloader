...
class ContentInfoSerializer(serializers.Serializer):
    ...
    file_size = serializers.CharField(max_length=100, required=False, allow_blank=True, allow_null=True)
    ...
    track = serializers.CharField(required=False, allow_blank=True, allow_null=True, max_length=300)
    artist = serializers.CharField(required=False, allow_blank=True, allow_null=True, max_length=300)
    album = serializers.CharField(required=False, allow_blank=True, allow_null=True,  max_length=300)
    # release_date = serializers.DateTimeField(format='%Y-%m-%d', required=False, allow_null=True)
    release_date = serializers.CharField(required=False, allow_blank=True, allow_null=True, max_length=100)
    channel = serializers.CharField(required=False, allow_blank=True, allow_null=True, max_length=300)
    uploader = serializers.CharField(required=False, allow_blank=True, allow_null=True, max_length=300)
