...
class ContentInfoSerializer(serializers.Serializer):
    ...
    duration = serializers.TimeField(format='%H:%M:%S', required=False)
    ...
    file_size = serializers.CharField(max_length=100, required=False)
    upload_date = serializers.DateTimeField(format='%Y-%m-%d', required=False)
    ...
    release_date = serializers.DateTimeField(format='%Y-%m-%d', required=False)
    release_date_string = serializers.CharField(required=False, max_length=100)
